  ...
  pics/turnout/.style args={#1/#2/#3}{code={%
    ...
    \begin{scope}[xscale=\facefactor, yscale=\branchfactor]%
      ...
      \ifdefstring{\operationmode}{manual}{% operation=manual
        ...
        \path[draw=\foreground,pattern=\patterntype, pattern color=\foreground] (0,0) -- ++(0.4,0) -- ++(0,0.4) -- cycle;% turnout marker
      }{%
        \ifdefstring{\operationmode}{remote}{% operation=remote
          \path[fill=\foreground] (0,0) -- ++(0.4,0) -- ++(0,0.4) -- cycle;% turnout marker
        }{%
          \ifdefstring{\operationmode}{none}{%
            \path[draw=\foreground] (0,0) -- ++(0.4,0) -- ++(0,0.4) -- cycle;% turnout marker
          }{%
      ...
      \iftoggle{fouling_point}{%
        \path[draw=\foreground] (0.7,0) -- ++(0,0.7);% fouling point indicator
      }{}%
      %
      %% points
