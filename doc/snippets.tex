...
\hline
\No & trigger point (forward) &
\symbol{trigger_point_forward.tikz} & \code{trigger_point_forward.tikz} &
\parbox[c]{4cm}{\centering\texttt{trafficcontrol} \\ Section \ref{sym:triggerpoint} p. \pageref{sym:triggerpoint}} \\

\hline
\No & trigger point (backward) &
\symbol{trigger_point_backward.tikz} & \code{trigger_point_backward.tikz} &
\parbox[c]{4cm}{\centering\texttt{trafficcontrol} \\ Section \ref{sym:triggerpoint} p. \pageref{sym:triggerpoint}} \\
