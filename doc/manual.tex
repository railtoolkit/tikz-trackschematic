...
\section{Provided Symbols and their commands}\label{sec:symbols}
  ...
  \subsection{Traffic control}
    ...
    \subsubsection{Non-stationary locations}\label{sec:locations}
      ...
      \symboldescription{Trigger point}\label{sym:triggerpoint}
        \tsSymbol[1.4]{trigger_point}
        \begin{lstlisting}[gobble=10]
          \triggerpoint[options] at (coord);
        \end{lstlisting}
        values for \texttt{options} (comma seperated):
        \begin{itemize}[label={}]
          \item \texttt{forward} or \texttt{backward} (mandatory)
        ...
        Symbology entry as seen at top:
        \begin{lstlisting}[gobble=10]
          \tsSymbol[1.4]{trigger_point}% TeX environment
        \end{lstlisting}
...
\section{Symbology}
  ...
  \begin{longtable}{|r|l|c|c|}
    ...
    \hline
      \No & trigger point                   & \tsSymbol[1.4]{trigger_point}                  & \ref{sec:locations}      \\
    \hline
